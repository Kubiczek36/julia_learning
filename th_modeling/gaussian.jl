...
# ╔═╡ b52ac154-2b66-46a2-9b4c-227480902657
using Images, Plots

# ╔═╡ 2ff6d508-4002-11ed-11f0-0be7c0313fc2
md"""
# Gaussian beams

![Gaußianbeamcalculation](./img/gauss.png)

"""

# ╔═╡ 975801b7-6914-499c-bd48-de34301d5009
λ = 580f-9;

# ╔═╡ d90f1fec-4aa8-4ce1-9e43-74e35c23e963
k = 2π/λ;

# ╔═╡ 6b1d3c7c-18db-4221-b02c-999124f461a7
W(z, z₀ = 1) = √(λ/(π * z₀)) .* √(1 + (z/z₀)^2);

# ╔═╡ 3bfe2d7b-8749-4508-ae62-2edb9a42d8bc
R(z, z₀ = 0) = ((z^2 + z₀^2)/z₀);

# ╔═╡ 1dde04ef-111a-4880-ae7c-bfaa34cc8752
u(x, y, z, W₀ = 1, k = k, z₀=1) = W₀/W(z) .* exp((-x.^2 .- y.^2)/W(z).^2) .* exp(-im.*k.*z .- im*k*(x^2 + y^2));

# ╔═╡ 14283501-6233-4d1e-b9db-2da18cd05ed1
I(x, y, z, W₀ = 1, k = k, z₀=0) = abs.(u.(x, y, z, W₀ = 1, k = k, z₀=0));

# ╔═╡ b863752e-2a13-4dc8-91e4-f0aa3dc0ffee
md"""
## Plot of the PSF in different planes.
"""

# ╔═╡ af8105c6-b2ca-43f6-ad43-b48dc2ed3304
W(0)*1f6

# ╔═╡ 16ddf663-0091-43a8-a29a-45da62032759
plot(-10:0.01:10, W.(-10:0.01:10))

# ╔═╡ d6e7f280-6ce3-4bd9-b832-ae686c69a73f
x = 0:0.001:2;

# ╔═╡ 31bc48ca-a0ea-45cd-b0e4-8909e3d36a19
u(x, 0.0, 0.0)

...
# ╔═╡ 83c0518c-2385-46fa-b1e5-c6fe8b0c204b
begin
	using Pkg
	Pkg.activate("../.")
end
...
# ╔═╡ 6ed13d85-aff6-4268-aebf-e9b45efdcb8e
...
# ╔═╡ e29a8c88-3e1a-48d1-9c35-07163c3500ea
xs = noisy_image[1, :]

# ╔═╡ 209b563b-d6d4-4d01-bfc7-af5a6ef176d2
ys = noisy_image[2, :]

# ╔═╡ b56bda98-65b7-4e30-8fde-5a888f33599f
...
begin
	...
	scatter(xs, ys, label="noisy", alpha=0.3, ms=4, ratio=1)
